...
17년간 서버 아키텍처 설계, 엔터프라이즈 고객 대응, 사업 개발을 넘나들며 기술을 비즈니스 성과로 전환해 온 엔지니어입니다. 카카오페이 대출 중계 시스템을 설계하여 월매출 230만원에서 2억 2천만원으로 95배 성장시켰고, Spring Boot에서 Go로의 프레임워크 전환을 주도하여 서버 자원 90%를 절감했습니다. 금융·블록체인·AI 도메인에서 MSA/HA 시스템을 설계·운영했으며, 미국과 한국의 엔터프라이즈 고객에게 직접 서비스를 배포하고 사업을 확장했습니다. 현재는 LLM 기반 프롬프트 엔지니어링과 에이전트 설계, ISO 27001 보안 체계 수립을 주도하며 AI 시대의 엔터프라이즈 솔루션을 만들어가고 있습니다.
